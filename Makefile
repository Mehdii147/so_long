...
SRC_FILES = main.c get_map.c get_next_line.c get_next_line_utils.c map_check.c valid_acces.c \
			player_moves.c so_long.c  utils.c
SRC_FILES_BONUS = main_bonus.c get_map_bonus.c get_next_line_bonus.c get_next_line_utils_bonus.c map_check_bonus.c valid_acces_bonus.c \
			player_moves_bonus.c so_long_bonus.c  utils_bonus.c enemy_update_bonus.c 
...
$(NAME): $(OBJ) $(LIBFT)
	@$(CC) $(CFLAGS) $(OBJ) -o $(NAME) -I inc/so_long.h -L. -lft -lmlx -framework OpenGL -framework AppKit
	@echo "\033[4;35m                                                            \n\
	  ▄████████  ▄██████▄          ▄█          ▄██████▄  ███▄▄▄▄      ▄██████▄      \n\
	 ███    ███ ███    ███        ███         ███    ███ ███▀▀▀██▄   ███    ███     \n\
	 ███    █▀  ███    ███        ███         ███    ███ ███   ███   ███    █▀      \n\
...
$(NAME_BONUS): $(OBJ_BONUS) $(LIBFT)
	@$(CC) $(CFLAGS) $(OBJ_BONUS) -o $(NAME_BONUS) -I inc/so_long_bonus.h -L. -lft -lmlx -framework OpenGL -framework AppKit
	@echo "\033[4;35m                                                            \n\
	  ▄████████  ▄██████▄          ▄█          ▄██████▄  ███▄▄▄▄      ▄██████▄      \n\
	 ███    ███ ███    ███        ███         ███    ███ ███▀▀▀██▄   ███    ███     \n\
	 ███    █▀  ███    ███        ███         ███    ███ ███   ███   ███    █▀      \n\
